...
class PackageMetadataTest(unittest.TestCase):
    ...
    def test_docs_explain_non_cwd_install_and_host_project_smoke(self):
        ...
        self.assertIn("## Install as an Agent Skill", readme)
        self.assertIn("## Install Python Package", readme)
        self.assertIn("<your-agent-skills-dir>/frame-timing-skill", readme)
        self.assertIn("repo: Taiquan-Zhou/frame-Extraction-and-Processing-skill", readme)
        self.assertNotIn("## AI Coding Tool Use", readme)
        self.assertNotIn("Codex", readme)
        self.assertNotIn("for development", readme)
        self.assertIn("## 作为 Agent Skill 安装", readme_zh)
        self.assertIn("## Usage", readme)
        self.assertIn("## 使用方法", readme_zh)
